...
\address{Software Engineer \linebreak Colombo, Sri Lanka}
\contacts{+94 71 551 0797 \linebreak sandarulj@outlook.com}
...
\begin{document}
	...
	\begin{cvsection}{Projects}
		\begin{cvsubsection}{}{}{}
			\begin{itemize}
				...
				\begin{itemize}
					\item Source code: \underbar{https://github.com/orgs/adaptivo-elearning/repositories}
				...
				\begin{itemize}
					\item Source code: \underbar{https://github.com/Rishy20/CMS\_Admin}
				...
				\begin{itemize}
					\item Source code: \underbar{https://github.com/SandaruLJ/study-management-app}
		...
		\begin{cvsubsection}{}{}{}
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item DOI: \underbar{10.1109/ICIC56845.2022.10007006}, Publisher: IEEE
				\end{itemize}
			\end{itemize}
		\end{cvsubsection}
	\end{cvsection}
	...
	\begin{cvsection}{Links}
		\begin{cvsubsection}{}{}{}
			\begin{itemize}
				\item GitHub: \underbar{https://github.com/SandaruLJ}
				\item LinkedIn: \underbar{https://www.linkedin.com/in/sandarulj}
			\end{itemize}
		\end{cvsubsection}
	\end{cvsection}
